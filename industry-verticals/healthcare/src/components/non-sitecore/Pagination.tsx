    ...
    <div className="mt-12 flex items-center justify-center space-x-2 text-sm md:space-x-4">
      ...
      {startPage > 1 && (
        <>
          <button
            ...
            className={`${paginationButtonClasses} ${currentPage === 1 ? 'bg-accent text-background' : 'bg-background-accent'
              }`}
          >
            1
          </button>
      ...
      {visiblePages.map((page) => (
        <button
          ...
          className={`${paginationButtonClasses} ${page === currentPage ? 'bg-accent text-background' : 'bg-background-accent'
            }`}
        >
          {page}
        </button>
      ...
      {endPage < totalPages && (
        <>
          ...
          <button
            ...
            className={`${paginationButtonClasses} ${currentPage === totalPages ? 'bg-accent text-background' : 'bg-background-accent'
              }`}
          >
            {totalPages}
          </button>
