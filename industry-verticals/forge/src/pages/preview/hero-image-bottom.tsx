/**
 * Preview page for HeroImageBottom component
 * Access at: http://localhost:3000/preview/hero-image-bottom
 *
...
export default function HeroImageBottomPreview() {
  return (
    <main className="min-h-screen bg-white">
      {/* Preview Header */}
      <div className="border-b border-neutral-200 bg-neutral-50 px-6 py-4">
        <p className="text-sm text-neutral-500">
          Component Preview: <span className="font-medium text-neutral-800">Hero Image Bottom</span>
        </p>
      </div>

      {/* Component Preview - Inline rendering matching HeroImageBottom.dev.tsx */}
      <section
      ...
      >
        <div className="relative">
          ...
          <div className="relative z-10 mx-auto flex min-h-[40vh] max-w-[1240px] flex-col items-start justify-end px-5 pb-12 pt-20 text-left @md/herowrapper:min-h-[45vh] @md/herowrapper:px-10 @md/herowrapper:pb-16 @lg/herowrapper:px-24">
            ...
            {/* Description */}
            <div className="mt-4">
              <p className="max-w-[45ch] text-pretty text-base font-light leading-relaxed tracking-wide text-white/90 @md/herowrapper:text-lg">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="text-neutral-600">
          This HeroImageBottom variant features a compact, elegant design with the image positioned
          as a full background. It includes:
        </p>
        <ul className="mt-4 list-inside list-disc space-y-2 text-neutral-600">
          <li>Full-bleed background image with lifestyle photography</li>
          <li>Sophisticated gradient overlay (dark-to-transparent from bottom)</li>
          <li>Decorative amber accent line at the bottom</li>
          <li>Content positioned at the bottom of the hero</li>
